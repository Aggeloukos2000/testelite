...
Config.Commands = {
	...
	[Lang("VISOR")] = {
		Func = function() TogglePropsDIO("Visor") end,
		Sprite = "visor",
		Desc = Lang("Visor2"),
		Button = 3,
		Name = Lang("Visor")
	...
	[Lang("HAT")] = {
		Func = function() TogglePropsDIO("Hat") end,
		Sprite = "hat",
	...
	[Lang("GLASSES")] = {
		Func = function() TogglePropsDIO("Glasses") end,
		Sprite = "glasses",
	...
	[Lang("EAR")] = {
		Func = function() TogglePropsDIO("Ear") end,
		Sprite = "ear",
	...
	[Lang("WATCH")] = {
		Func = function() TogglePropsDIO("Watch") end,
		Sprite = "watch",
	...
	[Lang("BRACELET")] = {
		Func = function() TogglePropsDIO("Bracelet") end,
		Sprite = "bracelet",
