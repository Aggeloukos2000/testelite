...
Citizen.CreateThread(function()
	...
	AddNewVariation("Bags", "Male", 21, 0)
	AddNewVariation("Bags", "Male", 22, 0)
	AddNewVariation("Bags", "Male", 23, 0)
	-- Female Bags
	AddNewVariation("Bags", "Female", 45, 44)
	AddNewVariation("Bags", "Female", 41, 40)
	AddNewVariation("Bags", "Female", 21, 0)
	AddNewVariation("Bags", "Female", 22, 0)
	AddNewVariation("Bags", "Female", 23, 0)
	-- Male Hair
	...
	AddNewVariation("Hair", "Male", 69, 66, true)
	AddNewVariation("Hair", "Male", 70, 66, true)
	-- Female Hair
