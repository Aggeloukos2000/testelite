--[[
	...
	["Handle"] = {      			First we name it, this is the string that will be put in the command to be used with ToggleClothing, or TogglePropsDIO.
...
local Extras = {
	...
	["Pants"] = {
		Drawable = 4,
		Table = { Standalone = true, Male = 21, Female = 15 },
